...
//    Excel'deki verileri Test sinifinda kullanmak icin bu method'u kullanacagiz
    ...
    //===============Excel'deki toplam sutun sayisini return eder=================
    ...
    //============Excel'deki datalari iki boyutlu Array olarak alir============
...
//    Bu method ustteki method'la birlikte calisir. Override eder. Parametreleri farklidir
    public void setCellData(String value, String columnName, int row) {
        int column = getColumnsNames().indexOf(columnName);
        setCellData(value, row, column);
    }

//    Excel'deki datalari basliksiz olarak 2 boyutlu Array seklinde return eder
